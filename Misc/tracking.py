...
class WandBTracker(Tracker):
    def __init__(self, exp_config, project_name):
        ...
        self.wandb = wandb
        wandb.init(config=exp_config, project=project_name)
...
class LocalTracker(Tracker):
    ...
    def __init__(self, exp_config, project_name):
        ...
        self.setup_dict = {"config": vars(exp_config), "project": project_name}
    ...
    def finish(self):
        output_dict = {"setup": self.setup_dict, "data": self.dicts}
        with open(self.tracking_file_path, "w") as file:
