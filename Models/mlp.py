...
class MLP(torch.nn.Module):
    ...
    def __init__(
        self,
        num_node_level_layers,
        num_graph_level_layers,
        node_encoder,
        emb_dim,
        num_classes,
        num_tasks,
        ...
        self.node_level_mlp = get_mlp(
            num_layers=num_node_level_layers,
            in_dim=emb_dim,
            out_dim=emb_dim,
        ...
        if self.prediction_type != PredictionType.NODE_EMBEDDING:
            self.prediction_mlp = get_mlp(
                num_layers=num_graph_level_layers,
                in_dim=emb_dim,
