...
class RunExpTest(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        for dir_name in [
            "ogbg-molesol_run_exp_test_config.yaml",
            "CSL_run_exp_test_config.yaml",
        ]:
    ...
    def test_run_exp_train_val_test(self):
        ...
        self.check_if_error_files_exist(
            os.path.join(config.RESULTS_PATH, "ogbg-molesol_run_exp_test_config.yaml")
        )
    ...
    def test_run_exp_cross_val(self):
        ...
        self.check_if_error_files_exist(
            os.path.join(config.RESULTS_PATH, "CSL_run_exp_test_config.yaml")
        )
